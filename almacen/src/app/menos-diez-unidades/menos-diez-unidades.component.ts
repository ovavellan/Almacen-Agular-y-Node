...
@Component({
  selector: 'app-menos-diez-unidades',
  templateUrl: './menos-diez-unidades.component.html',
  styleUrls: ['./menos-diez-unidades.component.css']
})
export class MenosDiezUnidadesComponent implements OnInit{
  ...
  traerTodosElectrodomesticos(){
    this.almacenService.getElectrodomesticosMenosDiez().then(data=>this.todosElectrodomesticos=data)
  }
